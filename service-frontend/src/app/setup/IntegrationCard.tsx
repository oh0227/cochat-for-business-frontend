...
export default function IntegrationCard({
  ...
  return (
    <div
      className="relative flex min-h-[150px] flex-col justify-between gap-3 rounded-[16px] p-4"
      style={{
    ...
    >
      ...
      {isConnected && (
        <div
          className="absolute right-[10px] top-[10px] flex size-5 items-center justify-center rounded-full"
      ...
      {comingSoon ? (
        <span
          className="flex h-9 w-full items-center justify-center rounded-[10px] font-medium"
        ...
        <button
          ...
          onClick={onConnect}
          disabled={isLoading}
          className="flex h-9 w-full items-center justify-center gap-2 rounded-[10px] font-medium text-white transition-opacity hover:opacity-80 disabled:opacity-60"
